...
class Project_Compiler {
    ...
    function generate_map_wads($catalog_handler) {
        ...
        foreach ($catalog as $map_data) {
            ...
            $this->import_between_markers($map_data, $wad_handler, ['MD_START'], ['MD_END'], 'models', 'md3 models', '.md3');
            $this->import_between_markers($map_data, $wad_handler, ['IQ_START'], ['IQ_END'], 'models', 'iqm models', '.iqm');            
            $this->import_between_markers($map_data, $wad_handler, ['MO_START'], ['MO_END'], 'models', 'obj models', '.obj');
            $this->import_between_markers($map_data, $wad_handler, ['MT_START'], ['MT_END'], 'models', 'model textures', '.png');
